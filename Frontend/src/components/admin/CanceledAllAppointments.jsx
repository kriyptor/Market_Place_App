...
import CanceledAllAppointmentsCard from './CanceledAllAppointmentsCard';
import PaginationComponent from './PaginationComponent';

function CanceledAllAppointments() {
  const BASE_URL = import.meta.env.VITE_API_BASE_URL;
   ...
   const fetchCanceledAppointments = async (page=1) => {
     ...
     setError(null);
     try {
       const response = await axios.get(`${BASE_URL}/appointment/admin/canceled`, {
...
export default CanceledAllAppointments